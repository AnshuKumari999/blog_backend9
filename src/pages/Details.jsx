...
const Details = (props) => {
  const [details, setDetails] = useState([
    ...
    },
    {
      id: 2,
      title:
        "Deepika Padukone EXUDES desi vibes with a modern touch in a white ruffle saree during the closing ceremony",
      Image:
        "https://st1.bollywoodlife.com/wp-content/uploads/2022/05/Deepika-76.png",
      category: "Bollywood",
      description:
    ...
    },
    {
      id: 4,
      title:
        "Liger is an Indian sports action film written and directed by Puri Jagannadh.",
      Image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSy4yqYueXkFa1IZ9NQpyuTs3yXpaWc1-Tupw&usqp=CAU",
      category: "Bollywood",
      description:
        "Liger is an Indian sports action film written and directed by Puri Jagannadh. Shot simultaneously in Hindi and Telugu languages, the film is produced by Dharma Productions and Puri Connects. Vijay Deverakonda stars as the titular MMA fighter alongside Ananya Panday, Ramya Krishna, and Ronit Roy in pivotal roles."
    },
    {
      id: 5,
      title:
        "Akshay Kumar was all praise for Manushi Chillar’s sharp memory during the promotions of Prithviraj",
      Image:
        "https://filmfare.wwmindia.com/content/2022/may/akshaykumarwasallpraises41653652745.jpg",
      category: "Bollywood",
      description:
    ...
    },
    {
      id: 6,
      title:
        "Kartik Aaryan opens up on his relationship status post his break up with Sara Ali Khan",
      Image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQQfZ7utkT-OunhbFrJgjyjJnaS1nWcbuyjxg&usqp=CAU",
      category: "Bollywood",
      description:
        "when Kartik began dating Sara Ali Khan amid shooting Love Aaj Kal 2. The duo had however split up but the reason for their break up was never clear.During an interaction with Film Companion, Kartik shared that he has been single for the past one year. His statement comes after Karan Johar recently confirmed his past relationship with Sara on his talk show. This also revealed how long has it been since they split."
    },
    {
      id: 54,
      title:
    ...
    },
    {
      id: 7,
      title:
        "Inside pictures from Karan Johar’s 50th birthday: Anushka Sharma and Ranbir Kapoor reunite",
      Image:
        "https://filmfare.wwmindia.com/content/2022/may/vickykaushal41653570327.jpg",
      category: "Bollywood",
      description:
    ...
    },
    {
      id: 8,
      title:
        "Bollywood Aishwarya Rai Bachchan, Abhishek Bachchan and daughter Aaradhya return ",
      Image:
        "https://www.pinkvilla.com/imageresize/abhishek%20bachchan%20aishwarya%20aaradhya%20%282%29.JPG?width=752&format=webp&t=pvorg",
      category: "Bollywood",
      description:
    ...
    },
    {
      id: 9,
      title:
        "Bollywood Deepika Padukone looks jaw droppingly stunning in latest photos",
      Image:
        "https://www.pinkvilla.com/imageresize/deepika_69.jpg?width=752&format=webp&t=pvorg",
      category: "Bollywood",
      description:
    ...
    },
    {
      id: 10,
      title:
        "Bollywood Alia Bhatt finally reacts to viral video of Ranbir Kapoor cradling a baby; cries 'happy tears'",
      Image:
        "https://st1.bollywoodlife.com/wp-content/uploads/2022/05/Alia-Ranbir-baby-video.jpg?impolicy=Medium_Widthonly&w=800",
      category: "Bollywood",
      description:
    ...
    {
      id: 11,
      title: "Narcos actor Wagner Moura discusses life after Pablo Escobar ",
      Image:
        "https://static.independent.co.uk/s3fs-public/thumbnails/image/2016/07/21/12/narcos-season-2_0.jpg?quality=75&width=990&auto=webp&crop=982:726,smart",
      category: "Hollywood",
      description:
        "Season two of Narcos hasnt been out for a week, yet attention has already turned to season three following confirmation the Netflix series will continue.However as the series about the drug trade continues, its lead villain - Pablo Escobar - will no longer feature in the show"
    },
    {
      id: 55,
      title:
        "Top Gun Maverick BO: Tom Cruise film collects $51 mn in US, ₹4.75 cr in India ",
      Image:
        "https://images.hindustantimes.com/img/2022/05/28/550x309/dcf35a88-dd9e-11ec-8fe2-ac5ac3115257_1653667000472_1653747840857.jpg",
      category: "mix",
      description:
    ...
    },
    {
      ...
      Image:
        "https://images.hindustantimes.com/img/2022/05/27/550x309/amber_heard_1652846124301_1653656835956.JPG",
      category: "Hollywood",
      description:
    ...
    },
    {
      ...
      Image:
        "https://images.indianexpress.com/2022/05/Facial-search-engine-featured.jpg",
      category: "Technology",
      description:
    ...
    },
    {
      ...
      Image:
        "https://images.indianexpress.com/2022/05/Celestial-calendar-2022-solar-lunar-eclipse-meteor-showers.jpg",
      category: "Technology",
      description:
    ...
    },
    {
      ...
      Image:
        "https://images.indianexpress.com/2022/03/bhagyashree-1200-new.jpg",
      category: "Fitness",
      description:
    ...
    },
    {
      ...
      Image:
        "https://www.verywellfit.com/thmb/3MvvjaqTvCD5A7YBCj51B7KR6ec=/800x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/exerciseCecilie_Arcurs-9b4222509db94b4ba991e86217bdc542.jpg",
      category: "Fitness",
      description:
    ...
    },
    {
      ...
      Image:
        "https://www.verywellfit.com/thmb/GO6ZNMAt2wgFWBBrMP3sYzN8F3o=/800x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/GettyImages-726775975-e35ebd2a79b34c52891e89151988aa02.jpeg",
      category: "Fitness",
      description:
    ...
    },
    {
      ...
      Image:
        "https://www.verywellfit.com/thmb/1LJpQJpL0Ek812XT-GlNOpOjE_4=/800x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/GettyImages-606353299-46be0bd52ffb43558df62348abf5fffb.jpg",
      category: "Fitness",
      description:
    ...
    },
    {
      id: 41,
      title:
        "Sunday Special: 7 Desi-Style Paneer Recipes To Amp Up Your Weekend Meal",
      Image:
        "https://c.ndtvimg.com/2022-05/nd11v1qg_palak-paneer_625x300_04_May_22.jpg?im=FaceCrop,algorithm=dnn,width=620,height=350",
      category: "Food",
      description:
    ...
    },
    {
      ...
      Image:
        "https://images.news18.com/ibnlive/uploads/2022/05/curd-rice-1-16519277623x2.jpg?impolicy=website&width=510&height=356",
      category: "Food",
      description:
    ...
    },
    {
      ...
      Image:
        "https://images.news18.com/ibnlive/uploads/2021/12/nagaland-16386760023x2.jpg?impolicy=website&width=510&height=356",
      category: "Food",
      description:
    ...
    },
    {
      id: 48,
      title:
        "Fruits and Vegetables are Losing Their Nutrient Value, Know the Risks",
      Image:
        "https://images.news18.com/ibnlive/uploads/2021/12/untitled-3-276-16409377143x2.jpg?impolicy=website&width=510&height=356",
      category: "Food",
      description:
    ...
    },
    {
      ...
      Image:
        "https://images.news18.com/ibnlive/uploads/2022/05/summer-drink-16518193713x2.jpg?impolicy=website&width=510&height=356",
      category: "Food",
      description:
    ...
    },
    {
      id: 50,
      title:
        "Unable to Find Tofu at Local Store? Here’s an Easy Recipe to Make it at Home",
      Image:
        "https://images.news18.com/ibnlive/uploads/2022/04/tofu-16510624083x2.jpg?impolicy=website&width=510&height=356",
      category: "Food",
      description:
